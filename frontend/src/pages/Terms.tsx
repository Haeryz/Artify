  ...
  return (
    <Container size="md" py="xl">
      ...
      <Text>
        ...
        the Artify platform ("Service") operated by Artify Inc. ("us", "we", or
      ...
      <Text>
        ...
        depending on the subscription plan you select). You authorize Artify
        Inc. to charge your chosen payment method automatically at the start of
        each billing period. Subscription fees are non-refundable except as
      ...
      {/* Section 3: Content */}
      <Title order={2}>3. User Content</Title>
      <Text>
        ...
        uploading it, you grant Artify Inc. a worldwide, non-exclusive,
      ...
      <Text>
        ...
        appropriateness of your User Content. Artify Inc. reserves the right to
      ...
      {/* Section 4: Accounts */}
      <Title order={2}>4. User Accounts</Title>
      <Text>
      ...
      <Title order={2}>6. Third-Party Links and Services</Title>
      <Text>
